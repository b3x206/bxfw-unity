// Copied from : https://forum.unity.com/threads/tv-static-shader.354472/
// If the author wants to remove/do something with this file, please open an issue or mail me.
...
Shader "Custom/TVStatic"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            { 
                fragmentInput o;
                UNITY_INITIALIZE_OUTPUT(fragmentInput, o); // Unity warning fix.
                   
                o.position = UnityObjectToClipPos (i.vertex);
                o.texcoord0 = i.texcoord0;
     
                // get the model's origin, so we can calculate the distance to camera
                // (and scale the noise accordingly)
            ...
            // Note : Changed VPOS to SV_POSITION to get rid of duplicate semantic error
